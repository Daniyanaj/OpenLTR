...
def get_config():
    ...
    parser.add_argument('--num_train_iter', type=int, default=262144,
    ...
    # config file
    parser.add_argument('--c', type=str, default='/data1/daniya_miccai24/NC/OpenLTR/config/openset_cv/openltr/isic2018.yaml')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    #model.load_model('/data1/daniya_miccai24/exp1/weighted_iomatch/IOMatch-main_isic2018/saved_models/openset_cv/inital/model_best.pth')
